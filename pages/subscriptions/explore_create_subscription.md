...
| registeredWithGP = [true/false] | 0..1 | 0..1 | This optional element would allow subscribers to choose if they want to receive data for patients depending upon the status of patient's GP registration. If the patient has a GP registration on PDS and the subscription criteria component specifies a value of `true`, then the criteria component will be considered a match.



If the patient does not have a registered GP on PDS and the subscription criteria component specifies a value of `false`, then the criteria component will be considered a match.



If the patient has a GP registration on PDS and the subscription criteria component specifies a value of `false`, then the criteria component will be considered not a match.



If the patient does not have a registered GP on PDS and the subscription criteria component specifies a value of `true`, then the criteria component will be considered not a match.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |`)<br/> - commas (`,`)<br/><br/>The `tag` value must contain a maximum of 100 characters. |
